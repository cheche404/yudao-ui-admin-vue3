<template>
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="只读域名" prop="hostReadonly">
        <el-input
          v-model="queryParams.hostReadonly"
          placeholder="请输入只读域名"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
...
<!--      <el-table-column label="Redis实例-ID" align="center" prop="id" />-->
      ...
      <el-table-column label="只读域名" align="center" prop="hostReadonly" width="420px"/>
...
const hasUpdatePerm = computed(() => {
  return userStore.permissions.has('cmdb:redis:update');
});

const hasDeletePerm = computed(() => {
  return userStore.permissions.has('cmdb:redis:delete');
});
