<template>
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="云实例ID" prop="instanceId" v-show="showMore">
        <el-input
          v-model="queryParams.instanceId"
          placeholder="请输入云实例ID"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
        />
      </el-form-item>
      <el-form-item label="云实例名称" prop="instanceName" v-show="showMore">
        <el-input
          v-model="queryParams.instanceName"
          placeholder="请输入云实例名称"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
        />
      ...
      <el-form-item label="exporterIP" prop="exporterIp" v-show="showMore">
        <el-input
...
<!--      <el-table-column label="主机ID" align="center" prop="id" />-->
      ...
      <el-table-column label="云实例ID" align="center" prop="instanceId" width="300px"/>
      <el-table-column label="云实例名称" align="center" prop="instanceName" width="300px"/>
