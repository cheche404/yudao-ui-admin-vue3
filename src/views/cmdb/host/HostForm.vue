  ...
  <Dialog :title="dialogTitle" v-model="dialogVisible">
    ...
    >
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <el-form-item label="云实例ID" prop="instanceId">
            <el-input v-model="formData.instanceId" placeholder="请输入云实例ID" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="云实例名称" prop="instanceName">
            <el-input v-model="formData.instanceName" placeholder="请输入云实例名称" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="是否K8S节点" prop="k8sNode">
            <el-select
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="监控exporterIP" prop="exporterIp">
...
.wide-form {
  max-width: 1200px;
  margin: 0 auto;
  padding: 0 20px; /* Ensure equal padding on both sides */
}
.wide-form :deep(.el-form-item__label) {
  min-width: 140px;
  white-space: nowrap;
}
</style>
